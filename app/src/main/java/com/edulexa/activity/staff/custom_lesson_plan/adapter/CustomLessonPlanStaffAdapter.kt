...
class CustomLessonPlanStaffAdapter(context: Activity, list: List<DatumCustomLesson?>?) :
    ...
    override fun onCreateViewHolder(
        ...
        binding = ItemStudentCustomLessonPlanBinding.inflate(
        ...
        try {
            ...
            if (!list!![position]!!.getLectureYoutubeUrl().equals("")) {
                ...
                if (!list!![position]!!.getPortionActuallyTaught().equals("")) {
                    ...
                    binding!!.tvPortionActuallyTaught.text =
                        list!![position]!!.getPortionActuallyTaught()
                ...
                if (!list!![position]!!.getHwNotAssignedReason().equals("")) {
                    ...
                    binding!!.tvHomeworkNotAssignedReason.text =
                        list!![position]!!.getHwNotAssignedReason()
            ...
            if (!list!![position]!!.getFile().equals("")) {
                ...
                if (!list!![position]!!.getPortionActuallyTaught().equals("")) {
                    ...
                    binding!!.tvPortionActuallyTaughtImage.text =
                        list!![position]!!.getPortionActuallyTaught()
                ...
                if (!list!![position]!!.getHwNotAssignedReason().equals("")) {
                    ...
                    binding!!.tvHomeworkNotAssignedReasonImage.text =
                        list!![position]!!.getHwNotAssignedReason()
                } else binding!!.homeworkNotAssignedReasonImageLay.visibility = View.GONE

                Utils.setImageUsingGlideImagePlaceholder(
                    context,
                    Constants.BASE_URL_WEBVIEW_DOMAIN_STAFF + list!!.get(position)!!.getFile(),
                    binding!!.ivImage
                )
            ...
            when (position % 3) {
                0 -> {
                    ...
                    binding!!.ivInfoImage.backgroundTintList =
                        ContextCompat.getColorStateList(context!!, R.color.circular_1)
                    binding!!.ivInfoVideo.backgroundTintList =
                        ContextCompat.getColorStateList(context!!, R.color.circular_1)
                    binding!!.ivDownload.backgroundTintList =
                        ContextCompat.getColorStateList(context!!, R.color.circular_1)
                }
                1 -> {
                    ...
                    binding!!.ivInfoImage.backgroundTintList =
                        ContextCompat.getColorStateList(context!!, R.color.circular_2)
                    binding!!.ivInfoVideo.backgroundTintList =
                        ContextCompat.getColorStateList(context!!, R.color.circular_2)
                    binding!!.ivDownload.backgroundTintList =
                        ContextCompat.getColorStateList(context!!, R.color.circular_2)
                ...
                2 -> {
                    ...
                    binding!!.imageDetailLay.setBackgroundResource(R.drawable.bg_subject_syllabus_blue)
                    binding!!.ivInfoImage.backgroundTintList =
                        ContextCompat.getColorStateList(context!!, R.color.circular_3)
                    binding!!.ivInfoVideo.backgroundTintList =
                        ContextCompat.getColorStateList(context!!, R.color.circular_3)
                    binding!!.ivDownload.backgroundTintList =
                        ContextCompat.getColorStateList(context!!, R.color.circular_3)
            ...
            binding!!.ivInfoImage.setOnClickListener(object : View.OnClickListener {
                override fun onClick(p0: View?) {
                    (context as CustomLessonPlanActivity).showInfoDialog(
                        list!!.get(position)!!.getComprehensiveQuestions()!!,
                        list!!.get(position)!!.getGeneralObjectives()!!,
                        list!!.get(position)!!.getPreviousKnowledge()!!,
            ...
            binding!!.tvDelete.setOnClickListener {
                (context as CustomLessonPlanActivity).deleteLesson(
                    list!![position]!!.getId()!!,
                    position
                )
            }
                ...
                Permissions.check(
                    ...
                    object : PermissionHandler() {
                        override fun onGranted() {
                            val imageUrl =
                                Constants.BASE_URL_WEBVIEW_DOMAIN_STAFF + list!![position]!!.getFile()
    ...
    class ViewHolder(binding: ItemStudentCustomLessonPlanBinding) :
