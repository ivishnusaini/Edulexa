...
class DatumCustomLesson {
    ...
    fun getLesson(): String? {
        return if (lesson == null) "" else lesson
    }
    ...
    fun getTopic(): String? {
        return if (topic == null) "" else topic
    }
    ...
    fun get_class(): String? {
        return _class
    }

    fun set_class(_class: String?) {
        this._class = _class
    }
