...
class DatumNotification {
    ...
    fun getPublishDate(): String? {
        return if (publishDate == null || publishDate == "null" || publishDate == "") "null" else publishDate
    }
    ...
    fun getDate(): String? {
        return if (date == null) "null" else date
    }
    ...
    fun getCreatedId(): String? {
        return if (createdId == null) "" else createdId
    }
