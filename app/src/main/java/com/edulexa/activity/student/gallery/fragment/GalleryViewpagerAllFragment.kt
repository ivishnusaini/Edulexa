...
class GalleryViewpagerAllFragment : Fragment() {
    ...
    companion object {
        ...
        var fragment: GalleryViewpagerAllFragment? = null
        fun newInstance(): GalleryViewpagerAllFragment? {
            fragment = GalleryViewpagerAllFragment()
            return fragment
        }

        fun getInstance(): GalleryViewpagerAllFragment? {
            return if (fragment == null) GalleryViewpagerAllFragment() else fragment
        }
    }
    ...
    fun setUpFeeList(){
        ...
        binding!!.galleryStudentRecyclerView.adapter = GalleryAlbumAdapter(mActivity!!,galleryList!!,"all")
    }
