...
class GalleryViewpagerDocumentFragment : Fragment() {
    ...
    companion object {
        ...
        var fragment: GalleryViewpagerDocumentFragment? = null
        fun newInstance(): GalleryViewpagerDocumentFragment? {
            fragment = GalleryViewpagerDocumentFragment()
            return fragment
        }

        fun getInstance(): GalleryViewpagerDocumentFragment? {
            return if (fragment == null) GalleryViewpagerDocumentFragment() else fragment
        }
    }
    ...
    fun setUpFeeList(){
        ...
        binding!!.galleryStudentRecyclerView.adapter = GalleryAlbumAdapter(mActivity!!,galleryList!!,"document")
    }
