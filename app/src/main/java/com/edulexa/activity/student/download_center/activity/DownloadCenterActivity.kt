...
class DownloadCenterActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun getDownloadCenterData() {
        if (Utils.isNetworkAvailable(mActivity!!)) {
            ...
            jsonObject.put(
                Constants.ParamsStudent.SECTIONID,
                Utils.getStudentSectionId(mActivity!!)
            )
                            ...
                            if (statusCode == 1) {
                                ...
                                if (resultJsonObj != null) {
                                    ...
                                    while (iterator.hasNext()) {
                                        ...
                                        val dayWiseJsonArr =
                                            JSONArray(resultJsonObj.optString(keyName))
                                        val downloadDetailModelList: List<DownloadDetailModel> =
                                            ArrayList()
                                        if (dayWiseJsonArr.length() > 0) {
                                            for (i in 0..dayWiseJsonArr.length() - 1) {
                                                ...
                                                downloadTypeDetailModel.setClassName(
                                                    dayWiseJsonObj.optString(
                                                        "class"
                                                    )
                                                )
                                                downloadTypeDetailModel.setClassId(
                                                    dayWiseJsonObj.optString(
                                                        "class_id"
                                                    )
                                                )
                                                downloadTypeDetailModel.setClassSectionId(
                                                    dayWiseJsonObj.optString("class_section_id")
                                                )
                                                downloadTypeDetailModel.setCreatedAt(
                                                    dayWiseJsonObj.optString(
                                                        "created_at"
                                                    )
                                                )
                                                downloadTypeDetailModel.setCreatedBy(
                                                    dayWiseJsonObj.optString(
                                                        "created_by"
                                                    )
                                                )
                                                downloadTypeDetailModel.setDate(
                                                    dayWiseJsonObj.optString(
                                                        "date"
                                                    )
                                                )
                                                downloadTypeDetailModel.setDirPath(
                                                    dayWiseJsonObj.optString(
                                                        "dir_path"
                                                    )
                                                )
                                                downloadTypeDetailModel.setFile(
                                                    dayWiseJsonObj.optString(
                                                        "file"
                                                    )
                                                )
                                                downloadTypeDetailModel.setId(
                                                    dayWiseJsonObj.optString(
                                                        "id"
                                                    )
                                                )
                                                downloadTypeDetailModel.setIsActive(
                                                    dayWiseJsonObj.optString(
                                                        "is_active"
                                                    )
                                                )
                                                downloadTypeDetailModel.setIsPublic(
                                                    dayWiseJsonObj.optString(
                                                        "is_public"
                                                    )
                                                )
                                                downloadTypeDetailModel.setNote(
                                                    dayWiseJsonObj.optString(
                                                        "note"
                                                    )
                                                )
                                                downloadTypeDetailModel.setSection(
                                                    dayWiseJsonObj.optString(
                                                        "section"
                                                    )
                                                )
                                                downloadTypeDetailModel.setTag(
                                                    dayWiseJsonObj.optString(
                                                        "tag"
                                                    )
                                                )
                                                downloadTypeDetailModel.setThumbName(
                                                    dayWiseJsonObj.optString(
                                                        "thumb_name"
                                                    )
                                                )
                                                downloadTypeDetailModel.setThumbPath(
                                                    dayWiseJsonObj.optString(
                                                        "thumb_path"
                                                    )
                                                )
                                                downloadTypeDetailModel.setTitle(
                                                    dayWiseJsonObj.optString(
                                                        "title"
                                                    )
                                                )
                                                downloadTypeDetailModel.setType(
                                                    dayWiseJsonObj.optString(
                                                        "type"
                                                    )
                                                )
                                                downloadTypeDetailModel.setUpdateAt(
                                                    dayWiseJsonObj.optString(
                                                        "updated_at"
                                                    )
                                                )
                                                downloadTypeDetailModel.setVideoTitle(
                                                    dayWiseJsonObj.optString(
                                                        "video_title"
                                                    )
                                                )
                                                downloadTypeDetailModel.setVideoUrl(
                                                    dayWiseJsonObj.optString(
                                                        "video_url"
                                                    )
                                                )
                                                (downloadDetailModelList as ArrayList<DownloadDetailModel>).add(
                                                    downloadTypeDetailModel
                                                )
                                            }
                                        }
                                        downloadCenterModel.setType(keyName)
                                        downloadCenterModel.setTypeWiseList(downloadDetailModelList)
                                        (downloadCenterList as ArrayList<DownloadCenterModel>).add(
                                            downloadCenterModel
                                        )
                                    }
                                    if (downloadCenterList.size > 0) {
                                        (downloadCenterList as ArrayList<DownloadCenterModel>).get(0)
                                            .setSelectedFlag(true)
                                        binding!!.studentDownloadCenterTypeRecycler.layoutManager =
                                            LinearLayoutManager(
                                                mActivity,
                                                RecyclerView.HORIZONTAL, false
                                            )
                                        binding!!.studentDownloadCenterTypeRecycler.adapter =
                                            DownloadCenterTypeAdapter(
                                                mActivity!!,
                                                downloadCenterList
                                            )
                                        setUpViewPager()
    ...
    private fun setUpViewPager() {
        binding!!.viewPagerDownloadCenter.adapter =
            ViewpagerDownloadCenterAdapter(
                supportFragmentManager,
                downloadCenterList,
                downloadCenterList.size
            )
