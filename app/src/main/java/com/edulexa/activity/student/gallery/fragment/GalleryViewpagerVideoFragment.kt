...
class GalleryViewpagerVideoFragment : Fragment() {
    ...
    companion object {
        ...
        var fragment: GalleryViewpagerVideoFragment? = null
        fun newInstance(): GalleryViewpagerVideoFragment? {
            fragment = GalleryViewpagerVideoFragment()
            return fragment
        }

        fun getInstance(): GalleryViewpagerVideoFragment? {
            return if (fragment == null) GalleryViewpagerVideoFragment() else fragment
        }
    }
    ...
    fun setUpFeeList(){
        ...
        binding!!.galleryStudentRecyclerView.adapter = GalleryAlbumAdapter(mActivity!!,galleryList!!,"video")
    }
